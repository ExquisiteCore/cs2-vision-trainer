...
class DatasetBuildOptions:
    ...
    def validate(self) -> None:
        ...
        normalize_class_names(self.class_names)
...
def write_dataset_yaml(output_root: Path, class_names: tuple[str, ...] = DEFAULT_CLASS_NAMES) -> Path:
...
def build_yolo_dataset(
    *,
    ...
    dataset_yaml = write_dataset_yaml(output_root, options.class_names)
